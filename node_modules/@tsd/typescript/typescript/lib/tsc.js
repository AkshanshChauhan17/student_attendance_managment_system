...
(function (ts) {
    ...
    function createSingleWatcherPerName(cache, useCaseSensitiveFileNames, name, callback, createWatcher) {
        ...
        if (existing) {
            ...
            cache.set(path, {
                watcher: createWatcher((function (param1, param2, param3) { var _a; return (_a = cache.get(path)) === null || _a === void 0 ? void 0 : _a.callbacks.slice().forEach(function (cb) { return cb(param1, param2, param3); }); })),
                callbacks: [callback]
            });
        }
        return {
